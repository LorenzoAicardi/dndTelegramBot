...
def start(update: Update, context: CallbackContext) -> int:
    context.user_data["Group chat id"] = update.effective_chat.id
    if "activeCampaign" in context.user_data:  # THIS FUCKING WORKS
        print(context.user_data["activeCampaign"])
    startingMenu = [[KeyboardButton("New campaign")], [KeyboardButton("Load campaign")]]
    context.bot.send_message(chat_id=context.user_data["Group chat id"],
        ...
        if key != "dm":
            if key.endswith("char"):
                stats = Statistics.loadStats(
                    ...
                    campaign[key]["stats"]["initiative"], campaign[key]["stats"]["speed"], campaign[key]["stats"]["hp"], campaign[key]["stats"]["hd"],
                    campaign[key]["stats"]["max_hd"], campaign[key]["stats"]["strMod"], campaign[key]["stats"]["dexMod"], campaign[key]["stats"]["constMod"],
                    campaign[key]["stats"]["intlMod"], campaign[key]["stats"]["wisMod"], campaign[key]["stats"]["chaMod"], campaign[key]["stats"]["hd_number"],
                    campaign[key]["stats"]["lvlUpPoints"], campaign[key]["stats"]["strength"], campaign[key]["stats"]["dex"], campaign[key]["stats"]["const"],
                    campaign[key]["stats"]["intl"], campaign[key]["stats"]["wis"], campaign[key]["stats"]["cha"], campaign[key]["stats"]["spell_slots"],
                ...
                equipment = Equipment.Equipment(Wealth.Wealth(
                    ...
                    campaign[key]["equipment"]["wealth"]["ep"], campaign[key]["equipment"]["wealth"]["gp"], campaign[key]["equipment"]["wealth"]["pp"]
                ),
